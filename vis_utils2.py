...
# vis_utils2.py
#
# 2020/07/30 atlan@antillia.com

# Based on visualization_utils.py, we have ddded something_with_filters functions
# For example: def visualize_boxes_and_labels_on_image_array_with_filters()
#
...
#2020/07/30 Added filters, id and detected_objects parameters
...
def draw_bounding_box_on_image_with_filters(filters, #
  ...
  #2020/07/30 comment out the following several lines.
  #if thickness > 0:
...
def visualize_boxes_and_labels_on_image_array_with_filters(
  ...
  # 2020/07/30 atlan: Draw filtered boxes onto image.
  detected_objects = []
